      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="flex justify-center md:justify-start">
          <button
            ...
            className="max-w-max flex items-center gap-2.5 px-6 py-3 rounded-full bg-gradient-to-r from-cyan-500 to-emerald-500 text-white font-bold shadow-lg shadow-cyan-500/20 hover:scale-[1.02] transition-transform duration-300"
          >
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6">
                  {coreProjects.map((proj, idx) => (
                    <div key={idx} className="rounded-3xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 p-6 shadow-sm shadow-slate-200/50 dark:shadow-black/20">
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                        <div>
                          <h5 className="font-bold text-slate-900 dark:text-white text-lg">
                            {proj.project}
                          </h5>
                          <p className="mt-2 text-xs uppercase tracking-[0.3em] text-cyan-500 dark:text-cyan-400 font-semibold">
                            {proj.role}
                          </p>
                        </div>
                        <span className="inline-flex items-center rounded-full bg-cyan-500/10 text-cyan-700 dark:text-cyan-300 px-3 py-1 text-[11px] font-semibold">
                          {proj.period}
                        </span>
                      </div>
                      <p className="mt-4 text-sm md:text-base text-slate-600 dark:text-slate-300 leading-7">
                        {proj.description}
                      </p>
                      <ul className="mt-4 grid gap-3 pl-4 list-disc text-sm text-slate-600 dark:text-slate-300">
